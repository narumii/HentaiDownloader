    ...
    public Document createJsoup(String url) {
        try {
            return Jsoup.connect(url)
                    .cookie("ipb_member_id", PropertiesHelper.getProperty("exhentai_cookie_ipb_member_id")) //exhentai access
                    .cookie("ipb_pass_hash", PropertiesHelper.getProperty("exhentai_cookie_ipb_pass_hash")) //exhentai access
                    .cookie("igneous", PropertiesHelper.getProperty("exhentai_cookie_igneous")) //exhentai access
